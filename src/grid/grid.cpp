...
protected:
  ...
  bool OnInitialize()
  {
    ...
    glMatrixMode(GL_MODELVIEW);
		...
		for(int x = 0; x < dim; ++x)
		{
			for(int y = 0; y < dim; ++y)
			{
				stars[6*starsCount+0] = 0.0f;
				stars[6*starsCount+1] = 0.0f;
				stars[6*starsCount+2] = 0.0f;
				stars[6*starsCount+3] = (((double)x/dim) * 2 - 1) * 4;
				stars[6*starsCount+4] = (((double)y/dim) * 2 - 1) * 4;
				stars[6*starsCount+5] = -4;
				...
				stars[6*starsCount+2] = 0.0f;
				stars[6*starsCount+3] = (((double)x/dim) * 2 - 1) * 4;
				stars[6*starsCount+4] = -4;
				stars[6*starsCount+5] = (((double)y/dim) * 2 - 1) * 4;
				...
				stars[6*starsCount+1] = 0.0f;
				stars[6*starsCount+2] = 0.0f;
				stars[6*starsCount+3] = -4;
				stars[6*starsCount+4] = (((double)x/dim) * 2 - 1) * 4;
				stars[6*starsCount+5] = (((double)y/dim) * 2 - 1) * 4;
    ...
    for(int i = 0; i < 100; ++i)
    {
      ...
      stars[6*i+1] = 0.0f;
      stars[6*i+2] = 0.0f;
      stars[6*i+3] = ((double)i/(100-1) * 2 - 1) * 4;
      ...
      stars[6*i+5] = (((float)rand() / ((float)RAND_MAX + 1)) * 2 - 1) * 4;
			...
			if(i&1) {
				int r = rand() % 3;
				if(r == 0) {
					stars[6*i+3] = stars[6*i+3 - 6];
					stars[6*i+4] = stars[6*i+4 - 6];
				} else if(r == 1) {
					stars[6*i+3] = stars[6*i+3 - 6];
					stars[6*i+5] = stars[6*i+5 - 6];
				} else {
					stars[6*i+4] = stars[6*i+4 - 6];
					stars[6*i+5] = stars[6*i+5 - 6];
				}
  ...
  void OnDraw()
  {
    ...
    glRotatef(theta,0,0,1.0);
		//glRotatef(cos(0.2*theta)*10,0,1,0);
		//glRotatef(sin(0.3*theta+2)*10,1,0,0);
